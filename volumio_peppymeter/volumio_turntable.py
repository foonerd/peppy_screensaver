...
class AlbumArtRenderer:
    ...
    def _process_image_bytes(self, img_bytes):
        """Process image bytes into scaled surface and rotation frames. Returns True on success."""
        surf = None
        if PIL_AVAILABLE:
    ...
    def load_from_bytes(self, img_bytes, source_id):
        """Load image from bytes (e.g. from HTTP response). source_id used for change detection."""
